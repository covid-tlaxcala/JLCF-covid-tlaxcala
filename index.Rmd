...
Mex_Data_COVID$Age_group <- factor(Mex_Data_COVID$Age_group,
                                   levels = c("Mayores.de.90","De.80.a.89","De.70.a.79",
                                              "De.60.a.69","De.50.a.59","De.40.a.49",
                                              "De.30.a.39","De.20.a.29","Menores.de.20"))
...
Mex_Data_COVID$mes_cont <- factor(Mex_Data_COVID$mes_cont,  levels = c("Marzo 2020", "Abril 2020", "Mayo 2020", "Junio 2020", "Julio 2020", "Agosto 2020", "Septiembre 2020", "Octubre 2020", "Noviembre 2020", "Diciembre 2020", "Enero 2021", "Febrero 2021", "Marzo 2021", "Abril 2021","Mayo 2021","Junio 2021","Julio 2021"))

Mex_Data_COVID$mes_def <- factor(Mex_Data_COVID$mes_def,  levels = c("Marzo 2020", "Abril 2020", "Mayo 2020", "Junio 2020", "Julio 2020", "Agosto 2020", "Septiembre 2020", "Octubre 2020", "Noviembre 2020", "Diciembre 2020", "Enero 2021", "Febrero 2021", "Marzo 2021", "Abril 2021","Mayo 2021","Junio 2021","Julio 2021"))
...
Mx.1 <- ddply(Mex_Data_COVID, c("mes_cont","Age_group","value"), summarise,
...
#Hospitalizados
d.f <- ddply(Mex_Data_COVID, c("mes_cont","tipo_paciente","Age_group","value"), summarise,
                           casos = length(mes_cont))
...
# México
# Age group
Mx.1 <- ddply(Mex_Data_COVID, c("mes_def","Age_group","value"), summarise,
...
#Hospitalizados
d.f <- ddply(Mex_Data_COVID, c("mes_def","tipo_paciente","Age_group","value"), summarise,
                           casos = length(mes_def))
...
# Tlaxcala
# Age group
Tlx.1 <- ddply(Pos_Tlax, c("mes_cont","Age_group"), summarise,
                           casos = length(mes_cont))
Tlx.2 <- Tlx.1 %>% 
  pivot_wider(names_from = Age_group,
              values_from = casos)
...
```{r Contagios area-plot QRoo, warning=FALSE, echo=FALSE, fig.align="center"}
edo = "Quintana Roo"
